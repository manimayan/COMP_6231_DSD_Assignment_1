 ...
 */
public class MontrealServer extends UnicastRemoteObject implements CenterServer {
	...
	/** The logger. */
	private static Logger logger = Logger.getLogger("Montreal");
	...
	public void serverConnection(int port, MontrealServer montrealServerArg)
		...
		Registry registry1 = LocateRegistry.createRegistry(9991);
		registry1.bind("Montreal", montrealServer);

		logger.info("Montreal Server Started");
		System.out.println("\nMontreal server is loaded with initial data. Map size : " + teacherStudentRecords.size());
	...
	public synchronized String createTRecord(String firstName, String lastName, String address, String phone,
		...
		String resultMsg = this.mainServer.persistTeacherRecordInMap(teacherRecord, this.teacherStudentRecords)
				? "Teacher record " + teacherRecord.getRecordID() + " created in montreal location with name : "
						+ firstName + " " + lastName
	...
	public synchronized String createSRecord(String firstName, String lastName, String courseRegistered, String status,
		...
		String resultMsg = this.mainServer.persistStudentRecordInMap(studentRecord, this.teacherStudentRecords)
				? "Student record " + studentRecord.getRecordID() + " created in Montreal location with name : "
						+ firstName + " " + lastName
