...
public class LogWriter implements Serializable {
	...
	private static final String CLIENT_LOG_URL = "src/main/resources/logs/client/";

	/** The Constant SERVER_LOG_URL. */
	private static final String SERVER_LOG_URL = "src/main/resources/logs/server/";
